...
**مهم جداً:** يجب أن تستند تحليلك بشكل مباشر للمعلومات والمفاهيم من الكتب التي درستها أدناه. اذكر اسم الكتاب أو المفهوم الذي تستخدمه من الكتب. أظهر للقارئ أنك متخصص فعلاً وتستخدم المعرفة المكتسبة.

${knowledge ? `=== معرفتك من الكتب ===\n${knowledge}\n=== نهاية المعرفة ===` : ''}

قم بإجراء تحليل فني شامل ومعمق مستند على الكتب وأعطني:
1. الاتجاه العام (Trend) - مع توضيح السبب من الكتب
2. نقطة الدخول المقترحة (Entry) - أرقام دقيقة
3. وقف الخسارة (Stop Loss) - بناءً على مستويات الدعم والمقاومة من الكتب
4. ثلاثة أهداف ربح (TP1, TP2, TP3)
5. مستوى الثقة (Confidence) - مع التبرير
6. التفاصيل والسببية (Reasoning) - استشهد بمفاهيم محددة من الكتب مثل Price Action أو Harmonic Patterns أو إدارة المخاطر
7. تحذيرات المخاطر (Risk Warning)
